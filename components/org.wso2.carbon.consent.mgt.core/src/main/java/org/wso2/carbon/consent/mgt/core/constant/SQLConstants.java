...
public class SQLConstants {
    ...
    public static final String GET_SP_PURPOSE_WITH_VERSION_SQL = "SELECT SP.ID,SP.CONSENT_TYPE," +
            ...
            "ON SP.PURPOSE_ID = P.ID WHERE RECEIPT_SP_ASSOC =?";
    ...
    public static final String GET_RECEIPT_COUNT_ASSOCIATED_WITH_PURPOSE_VERSION = "SELECT COUNT(*) FROM " +
            "CM_SP_PURPOSE_ASSOC WHERE PURPOSE_ID IN (SELECT PURPOSE_ID FROM CM_PURPOSE_VERSION WHERE ID=?)";
    ...
    public static final String INSERT_PURPOSE_VERSION_SQL = "INSERT INTO CM_PURPOSE_VERSION " +
            "(PURPOSE_ID, VERSION, DESCRIPTION, TENANT_ID) VALUES (?, ?, ?, ?)";

    public static final String LIST_PURPOSE_VERSIONS_SQL = "SELECT ID, PURPOSE_ID, VERSION, DESCRIPTION, TENANT_ID " +
            "FROM CM_PURPOSE_VERSION WHERE PURPOSE_ID = ? ORDER BY VERSION ASC";
    ...
    public static final String GET_PURPOSE_VERSION_PII_CAT_SQL =
            ...
            "P.DISPLAY_NAME FROM CM_PURPOSE_VERSION_PII_CAT_ASSOC A " +
    ...
    public static final String GET_PURPOSE_VERSION_BY_ID_SQL = "SELECT ID, PURPOSE_ID, VERSION, DESCRIPTION, " +
            "TENANT_ID FROM CM_PURPOSE_VERSION WHERE ID = ?";

    public static final String DELETE_PURPOSE_VERSION_SQL = "DELETE FROM CM_PURPOSE_VERSION WHERE ID = ?";
