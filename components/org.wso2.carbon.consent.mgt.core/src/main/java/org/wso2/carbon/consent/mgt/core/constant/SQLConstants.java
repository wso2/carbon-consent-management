...
public class SQLConstants {
    ...
    public static final String INSERT_PII_CATEGORY_SQL = "INSERT INTO CM_PII_CATEGORY (NAME, DESCRIPTION) VALUES (?," +
            "?)";
    public static final String SELECT_PII_CATEGORY_BY_ID_SQL = "SELECT ID, NAME, DESCRIPTION FROM CM_PII_CATEGORY " +
            "WHERE ID = ?";
    public static final String LIST_PAGINATED_PII_CATEGORY_MYSQL = "SELECT ID, NAME, DESCRIPTION FROM CM_PII_CATEGORY " +
            "ORDER BY ID ASC LIMIT ? OFFSET ?";
    public static final String DELETE_PII_CATEGORY_SQL = "DELETE FROM CM_PII_CATEGORY WHERE ID = ?";
    public static final String SELECT_PII_CATEGORY_BY_NAME_SQL = "SELECT ID, NAME, DESCRIPTION FROM CM_PII_CATEGORY " +
            "WHERE NAME = ?";
