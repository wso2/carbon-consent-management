...
public class ElementsApi  {
    ...
    private ElementsApiService delegate;
    ...
    @ApiOperation(value = "Create a consent element", notes = "Create a new consent element (e.g., \"email_address\", \"phone_number\"). ", response = ElementDTO.class, tags={ "Elements", })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Delete a consent element", notes = "Delete a consent element by ID. ", response = Void.class, tags={ "Elements", })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get a consent element", notes = "Retrieve a specific consent element by ID. ", response = ElementDTO.class, tags={ "Elements", })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List consent elements", notes = "Retrieve all consent elements. ", response = ElementListResponse.class, tags={ "Elements" })
    @ApiResponses(value = { 
    ...
    public Response elementsList(    @Valid @Min(1) @Max(200)@ApiParam(value = "Maximum number of records to return.", defaultValue="50") @DefaultValue("50")  @QueryParam("limit") Integer limit,     @Valid @Min(0)@ApiParam(value = "Number of records to skip before collecting the response set.", defaultValue="0") @DefaultValue("0")  @QueryParam("offset") Integer offset) {
