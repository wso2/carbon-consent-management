...
public class PurposesApi  {
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List all purposes", notes = "Retrieve all purposes with optional filtering by group or groupType. ", response = PurposeListResponse.class, authorizations = {
        @Authorization(value = "BasicAuth"),
        @Authorization(value = "OAuth2", scopes = {
    ...
    public Response purposesList(    @Valid @Size(max=255)@ApiParam(value = "Filter by purpose group.")  @QueryParam("group") String group,     @Valid @Size(max=255)@ApiParam(value = "Filter by purpose group type.")  @QueryParam("groupType") String groupType,     @Valid @Min(1)@ApiParam(value = "Maximum number of records to return.", defaultValue="10") @DefaultValue("10")  @QueryParam("limit") Integer limit,     @Valid @Min(0)@ApiParam(value = "Number of records to skip before collecting the response set.", defaultValue="0") @DefaultValue("0")  @QueryParam("offset") Integer offset) {
    ...
    public Response purposesVersionsList(@ApiParam(value = "Unique identifier of the purpose.",required=true) @PathParam("purposeId") Integer purposeId,     @Valid @Min(1)@ApiParam(value = "Maximum number of records to return.", defaultValue="10") @DefaultValue("10")  @QueryParam("limit") Integer limit,     @Valid @Min(0)@ApiParam(value = "Number of records to skip before collecting the response set.", defaultValue="0") @DefaultValue("0")  @QueryParam("offset") Integer offset) {
