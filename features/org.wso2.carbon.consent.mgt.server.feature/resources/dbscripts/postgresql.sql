...
CREATE TABLE CM_PII_CATEGORY (
  ...
  CONSTRAINT CM_PII_CATEGORY_CONSTRAINT UNIQUE (NAME, TENANT_ID),
  PRIMARY KEY (ID)
);
...
CREATE TABLE CM_PURPOSE (
  ...
  DESCRIPTION VARCHAR(1023),
  TENANT_ID   INTEGER DEFAULT '-1234',
  CONSTRAINT CM_PURPOSE_CONSTRAINT UNIQUE  (NAME, TENANT_ID),
  PRIMARY KEY (ID)
);
...
CREATE TABLE CM_PURPOSE_CATEGORY (
  ...
  DESCRIPTION VARCHAR(1023),
  TENANT_ID   INTEGER DEFAULT '-1234',
  CONSTRAINT CM_PURPOSE_CATEGORY_CONSTRAINT UNIQUE  (NAME, TENANT_ID),
  PRIMARY KEY (ID)
);
...
CREATE TABLE CM_RECEIPT_SP_ASSOC (
  ...
  CONSTRAINT CM_RECEIPT_SP_ASSOC_CONSTRAINT UNIQUE  (CONSENT_RECEIPT_ID, SP_NAME, SP_TENANT_ID),
  PRIMARY KEY (ID)
);
...
CREATE TABLE CM_SP_PURPOSE_ASSOC (
  ...
  CONSTRAINT CM_SP_PURPOSE_ASSOC_CONSTRAINT UNIQUE  (RECEIPT_SP_ASSOC, PURPOSE_ID),
  PRIMARY KEY (ID)
);

DROP TABLE IF EXISTS CM_SP_PURPOSE_PURPOSE_CAT_ASSOC;
CREATE TABLE CM_SP_PURPOSE_PURPOSE_CAT_ASSOC (
  SP_PURPOSE_ASSOC_ID INTEGER NOT NULL,
  PURPOSE_CATEGORY_ID INTEGER NOT NULL,
  CONSTRAINT CM_SP_PURPOSE_PURPOSE_CAT_ASSOC_CONSTRAINT UNIQUE  (SP_PURPOSE_ASSOC_ID, PURPOSE_CATEGORY_ID)
);
...
CREATE TABLE CM_PURPOSE_PII_CAT_ASSOC (
  ...
  CONSTRAINT CM_PURPOSE_PII_CAT_ASSOC_CONSTRAINT UNIQUE  (PURPOSE_ID, CM_PII_CATEGORY_ID)
);

DROP TABLE IF EXISTS CM_SP_PURPOSE_PII_CATEGORY_ASSOC;
CREATE TABLE CM_SP_PURPOSE_PII_CATEGORY_ASSOC (
  SP_PURPOSE_ASSOC_ID INTEGER NOT NULL,
  PII_CATEGORY_ID     INTEGER NOT NULL,
  VALIDITY            VARCHAR(1023),
  CONSTRAINT CM_SP_PURPOSE_PII_CATEGORY_ASSOC_CONSTRAINT UNIQUE  (SP_PURPOSE_ASSOC_ID, PII_CATEGORY_ID)
);
...
CREATE TABLE CM_CONSENT_RECEIPT_PROPERTY (
  ...
  CONSTRAINT CM_CONSENT_RECEIPT_PROPERTY_CONSTRAINT UNIQUE  (CONSENT_RECEIPT_ID, NAME)
);
