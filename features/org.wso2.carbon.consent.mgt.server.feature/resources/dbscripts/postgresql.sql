...
CREATE TABLE CM_SP_PURPOSE_ASSOC (
  ...
  CONSTRAINT CM_SP_PURPOSE_ASSOC UNIQUE  (RECEIPT_SP_ASSOC, PURPOSE_ID),
  PRIMARY KEY (ID)
);
...
CREATE TABLE CM_SP_PURPOSE_PURPOSE_CAT_ASSC (
  ...
  CONSTRAINT CM_SP_PURPOSE_PURPOSE_CAT_ASSC_CONSTRAINT UNIQUE  (SP_PURPOSE_ASSOC_ID, PURPOSE_CATEGORY_ID)
);
...
CREATE TABLE CM_PURPOSE_PII_CAT_ASSOC (
  ...
  CONSTRAINT CM_PURPOSE_PII_CAT_ASSOC UNIQUE  (PURPOSE_ID, CM_PII_CATEGORY_ID)
);
...
CREATE TABLE CM_SP_PURPOSE_PII_CAT_ASSOC (
  ...
  CONSTRAINT CM_SP_PURPOSE_PII_CAT_ASSOC_CONSTRAINT UNIQUE  (SP_PURPOSE_ASSOC_ID, PII_CATEGORY_ID)
);
...
CREATE TABLE CM_CONSENT_RECEIPT_PROPERTY (
  ...
  CONSTRAINT CM_CONSENT_RECEIPT_PROPERTY UNIQUE  (CONSENT_RECEIPT_ID, NAME)
);
