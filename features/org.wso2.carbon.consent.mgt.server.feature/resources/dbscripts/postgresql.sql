...
CREATE SEQUENCE IF NOT EXISTS CM_CONSENT_AUTHORIZATION_PK_SEQ;
CREATE TABLE IF NOT EXISTS CM_CONSENT_AUTHORIZATION (
  ID                 INTEGER DEFAULT NEXTVAL('CM_CONSENT_AUTHORIZATION_PK_SEQ'),
  CONSENT_RECEIPT_ID VARCHAR(255) NOT NULL,
  USER_ID            VARCHAR(255) NOT NULL,
  STATUS             VARCHAR(50)  NOT NULL,
  UPDATED_TIME       BIGINT       NOT NULL,
  CONSTRAINT CM_CONSENT_AUTHORIZATION_CNT UNIQUE (CONSENT_RECEIPT_ID, USER_ID),
  PRIMARY KEY (ID)
);
...
CREATE SEQUENCE IF NOT EXISTS CM_PURPOSE_VERSION_PII_CAT_ASSOC_PK_SEQ;
CREATE TABLE CM_PURPOSE_VERSION_PII_CAT_ASSOC (
  ID                 INTEGER DEFAULT NEXTVAL('CM_PURPOSE_VERSION_PII_CAT_ASSOC_PK_SEQ'),
  PURPOSE_VERSION_ID CHAR(36) NOT NULL,
  CM_PII_CATEGORY_ID INTEGER NOT NULL,
  IS_MANDATORY       INTEGER NOT NULL,
  CONSTRAINT CM_PURPOSE_VERSION_PII_CAT_ASSOC_CNT UNIQUE (PURPOSE_VERSION_ID, CM_PII_CATEGORY_ID),
  PRIMARY KEY (ID)
);

CREATE SEQUENCE IF NOT EXISTS CM_PURPOSE_VERSION_PROPERTY_PK_SEQ;
CREATE TABLE CM_PURPOSE_VERSION_PROPERTY (
  ID             INTEGER DEFAULT NEXTVAL('CM_PURPOSE_VERSION_PROPERTY_PK_SEQ'),
