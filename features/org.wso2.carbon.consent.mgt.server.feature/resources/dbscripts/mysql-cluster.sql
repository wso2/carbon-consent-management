...
-- Add indexes for nullable UUID columns (NDB engine)
ALTER TABLE CM_PII_CATEGORY ADD INDEX CM_PII_CATEGORY_UUID_IDX (UUID) ENGINE=NDDB;
ALTER TABLE CM_PURPOSE ADD INDEX CM_PURPOSE_UUID_IDX (UUID) ENGINE=NDDB;
