...
CREATE TABLE CM_SP_PURPOSE_ASSOC (
  ...
  CONSTRAINT SP_PURPOSE_ASSOC_CONSTRAINT UNIQUE (RECEIPT_SP_ASSOC, PURPOSE_ID),
  PRIMARY KEY (ID)
)
/
...
CREATE TABLE CM_SP_PURPOSE_PURPOSE_CAT_ASSOC (
  ...
  CONSTRAINT SP_PURPOSE_PURPOSE_CAT_ASSOC_CONSTRAINT UNIQUE (SP_PURPOSE_ASSOC_ID, PURPOSE_CATEGORY_ID)
)
/
CREATE TABLE CM_PURPOSE_PII_CAT_ASSOC (
  PURPOSE_ID         INTEGER NOT NULL,
  CM_PII_CATEGORY_ID INTEGER NOT NULL,
  CONSTRAINT PURPOSE_PII_CAT_ASSOC_CONSTRAINT UNIQUE (PURPOSE_ID, CM_PII_CATEGORY_ID)
)
/
CREATE TABLE CM_SP_PURPOSE_PII_CATEGORY_ASSOC (
  ...
  CONSTRAINT SP_PURPOSE_PII_CATEGORY_ASSOC_CONSTRAINT UNIQUE (SP_PURPOSE_ASSOC_ID, PII_CATEGORY_ID)
)
/
CREATE SEQUENCE CM_SP_PURPOSE_PII_CATEGORY_ASSOC_SEQ START WITH 1 INCREMENT BY 1 CACHE 20 ORDER
/
CREATE TABLE CM_CONSENT_RECEIPT_PROPERTY (
  CONSENT_RECEIPT_ID VARCHAR2(255)  NOT NULL,
  NAME               VARCHAR2(255)  NOT NULL,
  VALUE              VARCHAR2(1023) NOT NULL,
  CONSTRAINT CONSENT_RECEIPT_PROPERTY_CONSTRAINT UNIQUE (CONSENT_RECEIPT_ID, NAME)
)
/
