...
/
CREATE SEQUENCE CM_PURPOSE_VERSION_SEQ
  START WITH 1
  INCREMENT BY 1 NOCACHE
/
CREATE TRIGGER CM_PURPOSE_VERSION_TRIGGER NO CASCADE BEFORE INSERT ON CM_PURPOSE_VERSION
REFERENCING NEW AS NEW FOR EACH ROW MODE DB2SQL

BEGIN ATOMIC

    SET (NEW.ID)
       = (NEXTVAL FOR CM_PURPOSE_VERSION_SEQ);
